<?php
/**
 * Underscores Base Theme Theme Customizer
 *
...
function underscores_customize_preview_js() {
	wp_enqueue_script( 'underscores-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
